...
class Lang extends \Statical\BaseProxy
{
    ...
    public static function construct($domain = 'AMXXBG')
    {
        self::$domain = $domain;
    ...
    public static function load($file, $domain = 'AMXXBG', $path = false, $language = false)
    {
        // Set default path to forum core translations
        $path = $path ? $path : ForumEnv::get('AMXXBG_ROOT').'amxxbg/lang';
