...
class User extends \Statical\BaseProxy
{
    ...
    {
        return self::getBasic($id)->group_id == ForumEnv::get('AMXXBG_ADMIN');
    }
    ...
    {
        $user = self::getBasic($id);
        return $user->group_id == ForumEnv::get('AMXXBG_ADMIN') || Perms::getGroupPermissions($user->group_id, 'mod.is_mod');
    }
}
