    ...
    public static function validateSearchWord($word, $idx)
    {
        ...
        if (!isset($stopwords)) {
            if (!Cache::isCached('stopwords')) {
                Cache::store('stopwords', \AMXXBG\Model\Cache::getStopwords(), '+1 week');
            }
        ...
        return $numChars >= ForumEnv::get('AMXXBG_SEARCH_MIN_WORD') && $numChars <= ForumEnv::get('AMXXBG_SEARCH_MAX_WORD');
    }
