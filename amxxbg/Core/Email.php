...
class Email
{
    ...
    public static function send($to, $subject, $message, $replyToEmail = '', $replyToName = '')
    {
        ...
        $headers = 'From: ' . $from . $eOL . 'Date: ' . gmdate('r') . $eOL . 'MIME-Version: 1.0' . $eOL . 'Content-transfer-encoding: 8bit' . $eOL . 'Content-type: text/plain; charset=utf-8' . $eOL . 'X-Mailer: AMXXBG Mailer';
