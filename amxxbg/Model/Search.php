...
class Search
{
    ...
    {
        $this->search = new \AMXXBG\Core\Search();
    }
    ...
    public function getSearchResults($searchId = null)
    {
        ...
        elseif ($action == 'search') {
            ...
            if (preg_match('%^[\*\%]+$%', $keywords) || (Utils::strlen(str_replace(['*', '%'], '', $keywords)) < ForumEnv::get('AMXXBG_SEARCH_MIN_WORD') && !$this->search->isCjk($keywords))) {
                $keywords = '';
            }
