...
class Register
{
    public function checkErrors()
    {
        ...
        if (Input::post('language')) {
            ...
            if (!file_exists(ForumEnv::get('AMXXBG_ROOT').'amxxbg/lang/'.$user['language'].'/common.po')) {
    ...
    public function insertUser($user)
    {
        ...
        $intialGroupId = (ForumSettings::get('o_regs_verify') == '0') ? ForumSettings::get('o_default_user_group') : ForumEnv::get('AMXXBG_UNVERIFIED');
        ...
        if (ForumSettings::get('o_regs_verify') == '1') {
            Prefs::setUser($newUid, ['language' => $user['language']], ForumEnv::get('AMXXBG_UNVERIFIED'));
        } else {
        ...
        if (ForumSettings::get('o_mailing_list') != '') {
            ...
            if (isset($user['banned_email'])) {
                ...
                $mailTpl = trim(file_get_contents(ForumEnv::get('AMXXBG_ROOT').'amxxbg/lang/'.ForumSettings::get('language').'/mail_templates/banned_email_register.tpl'));
            ...
            if (!empty($dupeList)) {
                ...
                $mailTpl = trim(file_get_contents(ForumEnv::get('AMXXBG_ROOT').'amxxbg/lang/'.ForumSettings::get('language').'/mail_templates/dupe_email_register.tpl'));
            ...
            if (ForumSettings::get('o_regs_report') == '1') {
                ...
                $mailTpl = trim(file_get_contents(ForumEnv::get('AMXXBG_ROOT').'amxxbg/lang/'.ForumSettings::get('language').'/mail_templates/new_user.tpl'));
        ...
        if (ForumSettings::get('o_regs_verify') == '1') {
            ...
            $mailTpl = trim(file_get_contents(ForumEnv::get('AMXXBG_ROOT').'amxxbg/lang/'.$user['language'].'/mail_templates/welcome.tpl'));
